...
[![ci](https://github.com/edgeandedge/toolshed/actions/workflows/ci.yml/badge.svg)](https://github.com/edgeandedge/toolshed/actions/workflows/ci.yml)
...
```toml
thegraph-client-subgraphs = { git = "https://github.com/edgeandedge/toolshed.git", tag = "thegraph-client-subgraphs-vX.Y.Z" }
```
